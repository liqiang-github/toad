...
def KS_bucket(
    score, target, bucket=10, method="quantile", return_splits=False, **kwargs
):
    ...
    if bucket is False:
        ...
        df["bucket"], splits = merge(
            score, n_bins=bucket, method=method, return_splits=True, **kwargs
        )
    ...
    agg2["cum_lift"] = (
        agg2["cum_bads_prop" + reverse_suffix] / agg2["cum_total_prop" + reverse_suffix]
    )
